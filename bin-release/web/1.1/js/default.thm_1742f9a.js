...
generateEUI.paths['resource/eui_skins/btnzailaiyici.exml'] = window.btnzailaiyici = (function (_super) {
	__extends(btnzailaiyici, _super);
	function btnzailaiyici() {
		_super.call(this);
		this.skinParts = [];
	...
	var _proto = btnzailaiyici.prototype;
	...
	_proto._Image1_i = function () {
		...
		t.source = "btnzailaiyici_png";
		t.width = 129;
		t.x = 135.5;
		t.y = 121;
		return t;
	};
	return btnzailaiyici;
...
})(eui.Skin);generateEUI.paths['resource/eui_skins/ScrollerSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	__extends(ButtonSkin, _super);
	function ButtonSkin() {
		_super.call(this);
		this.skinParts = ["labelDisplay","iconDisplay"];
	...
	return ButtonSkin;
})(eui.Skin);generateEUI.paths['resource/eui_skins/StartButton.exml'] = window.startButtonSkin = (function (_super) {
		...
		this.states = [
			...
			new eui.State ("down",
				[
					...
					new eui.SetProperty("_Image1","scale9Grid",new egret.Rectangle(35,15,90,14))
				])
		];
	}
	...
	_proto._Image1_i = function () {
		...
		this._Image1 = t;
		t.percentHeight = 100;
		t.scale9Grid = new egret.Rectangle(35,15,90,14);
		t.source = "button_png";
		t.percentWidth = 100;
		return t;
	};
